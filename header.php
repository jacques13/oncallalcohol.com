...
?> 
 <div class="l-content-wrap js-content-wrap">
	<div class="l-content-wrap__inner-content js-page-content js-close-panel">
		...
		<div class="l-header__logo-and-nav" style="text-align: -webkit-center;">
		<h1 Style="color: #4f8098;
		background: rgba(218, 214, 214, 0.58);
		margin-top: -3.5rem;
		padding: 1rem;
		width: 120%;
		margin-left: -13rem;">On Call Alcohol</h1>
		...
		margin-top: 0%;">
		  ...
		  <div class="l-header__nav">
			<nav class="nav">
			  ...
			  <div class="nav__top-level">
				<div class="mobile-account-links">
				  
				</div>
	<!-- change links -->

				<a href="#products" class="nav__item js-products-link">Products</a>
				<a href="#specials" class="nav__item ">Specials</a>
				<?php 
					if($ismobile){
						echo '<a href="#" class="nav__item">Download our App</a>';
					}else{
						echo '<a href="#" class="nav__item">Cart</a><a href="#cart" class="nav__item">Download our App</a>';
					}
				?>
				
				<nav class="nav__item nav__item--offset sub-nav__toggle sub-nav__toggle--arrow">
				  <div class="sub-nav__title">Founders/Contact For Orders</div>
				  <ul class="sub-nav">
					<li class="sub-nav__item"><a href="#">Jacques Pieterse 0609946764</a></li>
					<li class="sub-nav__item"><a href="#">Arnold Van Schalkwyk 0724561666</a></li>
					<li class="sub-nav__item"><a href="#">Charlto Vorster 0828552046</a></li>
