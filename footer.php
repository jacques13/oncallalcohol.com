...
<div class="l-footer" style="background: #7fcbff;">
  <div class="l-footer__inner">

    <div class="l-footer__top">
      <div class="footer-eyebrow footer-eyebrow--left">A Proudly South African Service</div>
      <div class="footer-eyebrow footer-eyebrow--right">Alcohol Delivery</div>
...
<img src="./Images/Logo.png" style="
    Width:14.5%;
    margin-top: 0%;">
				<a href="#products" class="footer-nav__item">Products</a>
				<a href="#specials" class="footer-nav__item">Specials</a>
				<?php 
					if($ismobile){
						echo '<a href="#" class="footer-nav__item">Download our App</a>';
					}else{
						echo '<a href="#" class="footer-nav__item">Download our App</a><a href="#cart" class="footer-nav__item">Cart</a>';
					}
				?>
                <a href="#" class="footer-nav__item">Founders/contact for orders</a>
                <a href="#" class="footer-nav__item">Jacques Pieterse 060 994 6764</a>
                <a href="#" class="footer-nav__item">Arnold Van Schalkwyk 072 456 1666</a>
                <a href="#" class="footer-nav__item">Charlto Vorster 082 855 2046</a>
